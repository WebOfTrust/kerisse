...
# Created: 2023-08-11 
# Updated: -
# Description: This script backups directories related to scraping and search-index entries to a timestamped directory in the KERISSE_BACKUPS_DIR directory. The name of the directory containing the backups is the timestamp of the backup.
